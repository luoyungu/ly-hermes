...
export default function InteractivePet({ slug, status, scale = 0.5, onToggleHide }: InteractivePetProps): React.ReactElement {
  ...
  const currentStatus = overrideState || status
